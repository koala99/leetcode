...
//            System.out.println("sum1:" + data1.sum + ":" + data1.start + ":" + data1.end);
//            System.out.println("sum2:" + data2.sum + ":" + data2.start + ":" + data2.end);
//            System.out.println("sum3:" + data3.sum + ":" + data3.start + ":" + data3.end);
